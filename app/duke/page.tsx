    ...
    return <>
        <div id="container wrapper m-0 p-0 gx-0">
            ...
            <div className="container-lg workContent col-12 ">
                ...
                <hr className="hr" />
                <div className="row p-0 ms-0 work-bcg col-12 bgc ">
                    <div className="work-bcg-text">
                        ...
                        <p className="p1">As a Taiwanese, the "Duke" motorcycle series has been an iconic name that we've known our entire lives. "Duke" was a very popular scooter during the '90s. It's been a legend for the scooter market for around 15 years.<br></br>
                            <br></br>
                            In 2017, our company decided to launch a new scooter under the "Duke" name, hoping it would recapture the success of the original. However, the 2017 model shared only the name and none of the essence of its predecessor. As a lifelong fan of the original Duke, it was disheartening to see the name attached to a product so different from its roots.<br></br>
                            <br></br>The 2017 model struggled to gain a positive reputation. Most customers purchased it solely for its affordability, not its quality or features. By 2020, the scooter was falling behind its competitors, and its product life cycle was nearing its end. It was clear that change was needed. <br></br> <br></br></p>
                    </div>
                ...
                <div className="row p-0 ms-0 work-section work-bcg-text col-12">
                    ...
                    <div className="row p-0 ms-0 work-section duke-bcg-text col-12 bgc ">
                        <div className="work-result-text workH ">
                            <h1>Design</h1>
                    ...
                    <div className="row p-0 ms-0 work-section duke-bcg-text col-12">
                        <div className="work-result-text workH ">
                            ...
                            <ol className="duke-result">
                                ...
                                <li className="p1">Achieved 7,000-8,000 units/month in sales: Previously, a strong-selling scooter in the "normal" segment would reach around 4,000-5,000 units per month. However, the New Duke reached 9,000 units in its third month post-launch and maintained 7,000-8,000 units per month for six months.</li>
                                <li className="p1">Our company regained the leading brand position, securing over 40% of the market share after 20 years.</li>
                                <li className="p1">For the first time in the company's 60-year history, a single model became the top seller in the entire scooter market in its debut month.</li>
                            </ol>
                            <div className="duke-history-img">
